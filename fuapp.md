...
1. Create a Blob triggered Funcion
2. Create a Function app


## Task 1 : Create a blob trigger function
...
11. Python blob Trigger function processed blob name
...
5. In Basics tab Project detais are going to be filled
    ...
    -**Version (7)**
    -**Region (8)**
    -After finishing all these steps click **Review + Create (9)**
     ![](https://github.com/Tejees/function-app/blob/main/26.png)

     ![](https://github.com/Tejees/function-app/blob/main/27.png)

     ![](https://github.com/Tejees/function-app/blob/main/28.png)

 ---

6.After validating all the stepe Create **(1)**
    ![](https://github.com/Tejees/function-app/blob/main/29.png)
    
  - We can see the Overview of the function app after deployement
    ![](https://github.com/Tejees/function-app/blob/main/30.png)

---

7. Now Navigate to VS Code
    -In the Workspace Navigate **local project (1)**
     ![](https://github.com/Tejees/function-app/blob/main/31.png)
    
    -Right Click on local project and **Deploy in Azure (2)**
     ![](https://github.com/Tejees/function-app/blob/main/32.png)

    -Then It will show you the subscription **Innova8**
     ![](https://github.com/Tejees/function-app/blob/main/33.png)

    -Select the Funtion App **functionapptejeesh**
     ![](https://github.com/Tejees/function-app/blob/main/34.png)

    -It shows a option to **deploy**
     ![](https://github.com/Tejees/function-app/blob/main/35.png)
